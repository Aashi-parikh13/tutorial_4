...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\AASHI\\Desktop\\tutorial-4_lastrun.py',
...
trials = data.TrialHandler(nReps=48.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('C:/Users/AASHI/Desktop/cond.xlsx'),
...
# set up handler to look after randomisation of conditions etc
trials_2 = data.TrialHandler(nReps=48.0, method='fullRandom', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('C:/Users/AASHI/Desktop/cond.xlsx'),
...
# completed 48.0 repeats of 'trials_2'
